---
title: Claude Code
description: Claude Code 設定ガイド — Anthropic のターミナルベースのコーディングエージェントを MAX API で利用。コード理解、マルチファイル編集、IDE統合に対応。
---
...
<Callout type="info" title="MAX API 接続用の環境変数を設定する (Windows)">
...
<Callout type="info" title="MAX API 接続用の環境変数を設定する">
  コマンドを入力：
