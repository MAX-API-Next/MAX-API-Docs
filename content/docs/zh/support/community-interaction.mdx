...
欢迎加入 MAX API 开源社区！在这里，你可以与其他开发者交流经验，分享想法。
...
2. 群聊内容应聚焦 MAX API 的开源项目使用、部署、开发和反馈，不发布账号交易、购买引导或求购相关信息
3. 本群仅用于开源社区交流，请通过官方仓库、文档和社区渠道获取项目信息
4. MAX API 采用 GNU AGPLv3 开源协议；二次开发或商业使用还需同时遵守上游 One API / New API 的许可义务。符合项目署名或社区鸣谢展示要求的自用二开项目，可按 README 说明自动获得非永久临时商用授权。详情请查看[项目介绍](/zh/docs/guide/wiki/basic-concepts/project-introduction)
