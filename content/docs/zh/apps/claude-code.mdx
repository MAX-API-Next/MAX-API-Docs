---
title: Claude Code
description: Claude Code 教程 — 将 Anthropic 的终端编程助手对接 MAX API。支持代码理解、多文件编辑，集成 VS Code 与 JetBrains IDE。
---
...
<Callout type="info" title="设置 MAX API 接入环境变量 (Windows)">
...
<Callout type="info" title="设置 MAX API 接入环境变量">
  输入命令：
