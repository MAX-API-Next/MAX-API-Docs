...
description: Factory Droid CLI setup guide — install and configure this AI software engineering agent with MAX API. Supports end-to-end development from planning to testing.
---
...
<Callout type="info" title="Modify Environment Variables">
  ```powershell
  # Configure Droid CLI with your MAX API endpoint:
