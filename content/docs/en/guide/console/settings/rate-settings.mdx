...
Ratio settings are a core configuration of MAX API's internal cost accounting system. By setting different ratios, you can flexibly control internal cost allocation, budget control, or enterprise customer billing standards for various models and user groups.
...
MAX API adopts a dual billing mechanism of pre-consumption and post-consumption:
