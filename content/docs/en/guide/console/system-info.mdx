...
The System Information page is for Root administrators. It provides instance status, resource usage, and system-task information for multi-node deployments. Open **System Information** from the profile menu.
