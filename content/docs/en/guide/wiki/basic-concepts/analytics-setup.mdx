...
MAX API now supports integration with popular analytics platforms to help you track user behavior and website performance:
...
docker exec max-api env | grep -E "GOOGLE_ANALYTICS|UMAMI"
```
