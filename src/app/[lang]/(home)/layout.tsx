...
> = {
  en: {
    ...
    start: {
      ...
      desc: 'Learn how to deploy and configure MAX API.',
    },
    install: {
      text: 'Installation',
  ...
  zh: {
    ...
    skills: { text: 'Skills', desc: '' },
    start: { text: '快速开始', desc: '学习如何部署和配置 MAX API。' },
  ...
  ja: {
    ...
    skills: { text: 'Skills', desc: '' },
    start: { text: 'はじめに', desc: 'MAX API のデプロイと設定方法を学ぶ。' },
    install: {
      text: 'インストール',
        ...
        links={[
            ...
            children: (
              <NavbarMenu>
                ...
                <NavbarMenuContent className="text-[15px]">
                  <MenuLinkItem item={navItems[0]} className="md:row-span-2" />
                  {/* Second column */}
          ...
          },
          {
            ...
            children: (
              ...
              >
                {texts.skills.text}
                <span className="rounded-full bg-gradient-to-r from-purple-500 to-pink-500 px-1.5 py-0.5 text-[10px] leading-none font-semibold text-white">
                  New
                </span>
              </Link>
            ),
