...
> = {
  en: {
    default: 'MAX API - The Foundation of Your AI Universe',
    template: '%s | MAX API',
    description:
  ...
  zh: {
    default: 'MAX API - AI 基座',
    template: '%s | MAX API',
    description:
      '承载所有 AI 应用，管理你的数字资产，连接未来的统一基础设施平台。快速部署，轻松扩展。',
  },
  ja: {
    default: 'MAX API - あなたの AI ユニバースの基盤',
    template: '%s | MAX API',
    description:
...
export async function generateMetadata({
  ...
  return createMetadata({
    ...
    authors: [
      { name: 'MAX API Team', url: 'https://github.com/MAX-API-Next/MAX-API' },
    ],
    creator: 'MAX API Team',
    alternates: {
      languages: {
        en: '/en',
        zh: '/zh',
