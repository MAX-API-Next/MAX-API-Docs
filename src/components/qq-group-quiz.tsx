...
const translations = {
  en: {
    questions: [
      {
        id: 'q1',
        question: '1. What is MAX API?',
        options: [
          { value: 'a', label: 'A commercial API sales platform' },
          {
            value: 'b',
            label:
              'An open-source AI model governance, AgentOps, and API gateway infrastructure project',
          },
        ...
        correct: 'b',
        errorMessage:
          'Please re-read the project introduction. MAX API is an open-source AI model governance, AgentOps, and API gateway infrastructure project.',
      },
      {
        id: 'q2',
        question:
      ...
      {
        id: 'q3',
        question: '3. Does MAX API have a closed-source paid version?',
        options: [
          {
            value: 'true',
          ...
          },
          {
            value: 'false',
            label:
              'No, MAX API is open-source software with documented attribution and licensing requirements',
          },
        ],
        correct: 'false',
        errorMessage:
          'According to Group Rule 4: MAX API is open-source software with documented attribution and licensing requirements. For details, please see the Project Introduction.',
      },
      {
        id: 'q4',
        question:
  ...
  zh: {
    questions: [
      {
        id: 'q1',
        question: '1. MAX API 是什么？',
        options: [
          { value: 'a', label: '一个商业API销售平台' },
          { value: 'b', label: '一个开源的 AI 模型治理、AgentOps 与 API 网关基础设施项目' },
          { value: 'c', label: '一个付费软件' },
          { value: 'd', label: '一个公益API站点' },
        ],
        correct: 'b',
        errorMessage:
          '请重新阅读项目介绍。MAX API 是一个开源的 AI 模型治理、AgentOps 与 API 网关基础设施项目。',
      },
      {
        id: 'q2',
      ...
      {
        id: 'q3',
        question: '3. MAX API 是否有闭源的付费版本？',
        options: [
          { value: 'true', label: '有，存在付费的闭源版本' },
          {
            value: 'false',
            label: '没有，MAX API 采用 AGPLv3 开源协议，并提供 README 说明的二次开发鸣谢与临时商用授权规则',
          },
        ],
        correct: 'false',
        errorMessage:
          '根据群规第4条：MAX API 采用 GNU AGPLv3 开源协议，并提供 README 说明的二次开发鸣谢与临时商用授权规则。',
      },
      {
        id: 'q4',
  ...
  ja: {
    questions: [
      {
        id: 'q1',
        question: '1. MAX APIとは何ですか？',
        options: [
          { value: 'a', label: '商用API販売プラットフォーム' },
          {
            value: 'b',
            label: 'オープンソースの AI モデルガバナンス、AgentOps、API ゲートウェイ基盤',
          },
        ...
        correct: 'b',
        errorMessage:
          'プロジェクト紹介を再度お読みください。MAX API はオープンソースの AI モデルガバナンス、AgentOps、API ゲートウェイ基盤です。',
      },
      {
        id: 'q2',
        question:
      ...
      {
        id: 'q3',
        question: '3. MAX APIにはクローズドソースの有料版がありますか？',
        options: [
          { value: 'true', label: 'はい、クローズドソースの有料版があります' },
          {
            value: 'false',
            label:
              'いいえ、MAX API はオープンソースソフトウェアであり、README の帰属表示とライセンス条件に従います',
          },
        ],
        correct: 'false',
        errorMessage:
          'グループルール4により：MAX API はオープンソースソフトウェアであり、README の帰属表示とライセンス条件に従います。詳細については、プロジェクト紹介をご覧ください。',
      },
      {
        id: 'q4',
        question:
