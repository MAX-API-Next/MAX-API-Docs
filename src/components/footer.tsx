...
const socialLinks: { name: string; href: string; icon: React.ReactNode }[] = [
  ...
  {
    name: 'Docker',
    href: 'https://hub.docker.com/r/cscitechtop/max-api',
    icon: DockerIcon,
  },
  {
    name: 'QQ',
...
const relatedProjects: { label: string; href: string }[] = [
  ...
  { label: 'Suno API', href: 'https://github.com/Suno-API/Suno-API' },
];

const toolsLinks: { label: string; href: string }[] = [
  {
    label: 'max-api-key-tool',
    href: 'https://github.com/MAX-API-Next/MAX-API-key-tool',
  },
  {
    label: 'max-api-horizon',
    href: 'https://github.com/MAX-API-Next/MAX-API-horizon',
  },
];
...
const translations: Record<string, FooterTranslation> = {
  zh: {
    ...
    copyright: '© 2025 MAX-API-Next. All Rights Reserved.',
  },
  en: {
    sections: {
      about: {
...
function buildSections(t: FooterTranslation) {
  return [
    ...
    },
    {
      ...
      links: toolsLinks.map((p) => ({ ...p, external: true })),
    },
    {
